...
agent_one = Agent.load('domain', interpreter=interpreter,tracker_store=mongo_tracker_store, action_endpoint=action_endpoint)
...
agent_two = Agent.load('domain', interpreter=interpreter,tracker_store=mongo_tracker_store, action_endpoint=action_endpoint)
